    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                List<Candidato> candidatoList = candidatoServiceImpl.recuperarArchivo("c:/TProgra/Candidato.txt");
                candidatoServiceImpl.setCandidatoList(candidatoList);
                
                var dignidadServiceImpl = new DignidadServiceImpl();
                List<Dignidad> dignidadList = dignidadServiceImpl.recuperarArchivo("c:/TProgra/Dignidad.txt");
                dignidadServiceImpl.setDignidadList(dignidadList);
                
                var eleccionServiceImpl = new EleccionServiceImpl();
                List<Eleccion> eleccionList = eleccionServiceImpl.recuperarArchivo("c:/TProgra/Eleccion.txt");
                eleccionServiceImpl.setEleccionList(eleccionList);
            }
        });
    }
